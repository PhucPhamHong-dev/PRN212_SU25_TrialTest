...
public partial class Su25jlptmockTestDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CandidateId).HasName("PK__Candidat__DF539BFCB9809750");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__JLPTAcco__349DA58644A9AACD");

            entity.ToTable("JLPTAccount");

            entity.HasIndex(e => e.Email, "UQ__JLPTAcco__A9D10534DE47F9F6").IsUnique();
        ...
        {
            entity.HasKey(e => e.TestId).HasName("PK__MockTest__8CC3310047D18591");
